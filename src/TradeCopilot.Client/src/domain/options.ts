import type { AllocationRuleStatus, AssetType, PortfolioType, StrategicStatus, TransactionType } from "./types";
...
export const allocationRuleStatuses: AllocationRuleStatus[] = ["Active", "Frozen", "ExitOnly"];
