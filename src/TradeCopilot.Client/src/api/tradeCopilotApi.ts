...
export const tradeCopilotApi = {
  ...
  exportStrategyRules: () => getJson<StrategyRulesExport>("/api/strategy-rules/export"),
  importStrategyRules: (payload: StrategyRulesExport) => postJson<StrategyRuleImportResult>("/api/strategy-rules/import", payload),
